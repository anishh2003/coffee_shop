import 'package:coffee_shop_migrated/constants.dart';
...
ThemeData lightMode = ThemeData().copyWith(
  ...
  appBarTheme: AppBarTheme(backgroundColor: kColorLightScheme.primary),
  cardTheme: CardTheme(
    surfaceTintColor: kColorLightScheme.surfaceTint,
    elevation: 15.0,
  ),
  ...
  scrollbarTheme: ScrollbarThemeData(
    thumbColor: MaterialStateColor.resolveWith((states) {
      if (states.contains(MaterialState.pressed)) {
        return kColorLightScheme.primary.withOpacity(
          0.8,
...
ThemeData darkMode = ThemeData.dark().copyWith(
  ...
  appBarTheme: AppBarTheme(backgroundColor: kColorDarkScheme.primary),
  cardTheme: CardTheme(
    surfaceTintColor: kColorDarkScheme.surfaceTint,
    elevation: 15.0,
  ),
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ElevatedButton.styleFrom(
  ...
  scrollbarTheme: ScrollbarThemeData(
    thumbColor: MaterialStateColor.resolveWith((states) {
      if (states.contains(MaterialState.pressed)) {
        return kColorDarkScheme.primary.withOpacity(
          0.8,
        ); // Adjust opacity or color as needed
      }
